...
export default {
  ...
  data() {
    return {
      ...
      key: token,
      value: BearereyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1aWQiOjUwMCwicmlkIjowLCJpYXQiOjE2NTA1MTUzMTYsImV4cCI6MTY1MDYwMTcxNn0.bt1jbOMGqIfv8S6pXRGv_XQQRdlmx7lz2yvIZNVlGMc,
      // 表单验证规则对象
      loginFormRules: {
        // 验证用户名是否合法
        username: [
