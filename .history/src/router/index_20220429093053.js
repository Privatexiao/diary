...
const routes = [
  ...
  },
  {
    ...
    children:[
      ...
      {
        path:'/reports',
        component: () => import(/* webpackChunkName: "Report" */ '../components/vue-shop/report/Report.vue')
      }
    ]
  },  
  {
  ...
  },
  {
    path:'/sesamephone',
    name:'SesaMePhone',
    component: () => import(/* webpackChunkName: "SesaMePhone" */ '../components/KeFuZhuShou.vue')
  }
]
